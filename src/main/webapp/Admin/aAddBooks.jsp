                    ...
                    <%
                        try {
                            ...
                            while (rs.next()) {
                                ...
                                byte[] BookImagestr = rs.getBytes("BOOK_IMAGE");
                                String BookImage = java.util.Base64.getEncoder().encodeToString(BookImagestr);
                                String bookImage = "data:image/jpeg;base64," + BookImage;
                    %>
                    <tr>
                        <td class="table-plus">
