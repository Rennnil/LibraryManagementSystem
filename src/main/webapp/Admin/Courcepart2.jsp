	...
	<head>
		...
		<style>
			.cssbuttons-io-button {
				...
				display: flex;
				align-items: center;
				box-shadow: inset 0 0 1.6em -0.6em #f07070;
				overflow: hidden;
				position: relative;
				height: 2.8em;
				padding-right: 3.3em;
			  ...
			  .cssbuttons-io-button .icon {
				...
				width: 2.2em;
				border-radius: 0.7em;
				box-shadow: 0.1em 0.1em 0.6em 0.2em #f07070;
				right: 0.3em;
				transition: all 0.3s;
			  }
					...
					<!-- <div class="container mt-4">
						<div class="row"> -->
							...
							<!-- <div class="col-md-4">
								<div class="card">
									<div class="card-body"> -->
										<!-- Tutor information with Bootstrap classes -->
										<!-- <div class="d-flex  flex-lg-row  align-items-center mb-3">
											<img src="./src/images/photo1.jpg" class="img-fluid col-sm-12 col-lg-8 rounded-circle"alt="">
											<div class="ms-3 col-sm-12 col-lg-4">
												<h5 class="mb-0">John Deo</h5>
												<small class="text-muted">21-10-2022</small>
											</div>
										</div> -->
										<!-- Thumbnail with specified dimensions and video count overlay -->
										<!-- <div class="position-relative mb-3">
											<img src="thumb-1.png" class="img-fluid rounded" alt="">
										</div> -->
										<!-- Title of the playlist or tutorial -->
										<!-- <h4 class="card-title">Complete HTML Tutorial</h4> -->
										<!-- Link to the playlist with a Bootstrap button style -->
							...
							<ul class="row">
								<li class="col-lg-4 col-md-6 col-sm-12">
									<div class="product-box">
										<div class="product-caption d-flex justify-content-lg-start">
											<div >
													<img src="thumb-1.png" alt="" style="display: flex;
													justify-content: center;
													align-items: center;
													font-weight: 500;
													font-size: 16px;
										...
										<div class="product-caption">
											<h4><a href="#">HTML Playlist whatch</a></h4>
