        ...
        <div class="min-height-200px">
            ...
            <div class="row clearfix">
                <%
                    ...
                    try {
                        ...
                        Connection con = DriverManager.getConnection(
                                "jdbc:oracle:thin:@localhost:1521:XE", // SID-based for Oracle 10g
                                "system",
                                "system"
                        );
                        ...
                        printWriterout.println("Connected & Query Executed");
                        ...
                        while (rs.next()) {
                            ...
                            if (imgBytes != null) {
                                ...
                                imageSrc = "assets/images/default-avatar.jpg"; // fallback
                            }
                %>
                        ...
                        <div class="da-card-photo" style="height: 250px;">
                            ...
                            <div class="da-overlay">
                                <div class="da-social">
                                    <ul class="clearfix">
                                        <li>
                                            <a href="facultyDetails.jsp?id=<%=userId%>"><i class="fa fa-eye"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <%
                        ...
                        e.printStackTrace();
                        printWriterout.println("<div style='color:red;'>Error: " + e.getMessage() + "</div>");
                    }
                %>
            </div>
        </div>
