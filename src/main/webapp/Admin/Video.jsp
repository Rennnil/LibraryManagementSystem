...
<style>
	.responsive-video {
		width: 100%; /* Adjust this value to whatever you prefer */
		height: auto;
		max-width: 500px; /* Maximum width of the video */
		aspect-ratio: 16 / 9; /* Adjust according to your video's aspect ratio */
	}
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix mb-20">
							<div class="pull-left">
								...
								<p class="font-14 ml-0">A simple, accessible HTML5 media player</p>
								<video
