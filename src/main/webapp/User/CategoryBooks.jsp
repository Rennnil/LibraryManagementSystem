...
<%
    ...
    try {
        ...
        pst = con.prepareStatement("SELECT * FROM BOOK WHERE LOWER(TRIM(CATEGORY)) = LOWER(TRIM(?))");
        pst.setString(1, selectedCategory.trim());
        rs = pst.executeQuery();
...
<div class="container mt-4">
    ...
    <%
        ...
        switch (categoryNormalized) {
            ...
            case "romance":
            case "rommance": categoryClass = "bg-danger text-white"; break;
            case "children":
            case "children's fiction": categoryClass = "bg-warning text-dark"; break;
            ...
            case "mystery":
            case "mystery/thriller": categoryClass = "bg-info text-white"; break;
            case "mythology": categoryClass = "bg-light text-dark border"; break;
            default: categoryClass = "bg-secondary text-white"; break;
        }
    %>
