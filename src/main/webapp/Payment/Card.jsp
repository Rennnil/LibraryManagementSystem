...
<body>
    ...
    <div class="wrapper" id="app">
        <div class="card-form">
            ...
            %>
            <script>
                alert("Your payment is canceled. Please try again!");
            </script>
            <%
                }
            %>
            ...
            %>
            <form  method="post" action="../PayFineServlet">
                ...
                <div class="card-form__row">
                    <div class="card-form__col">
                        <div class="card-form__group">
                            ...
                            <select class="card-input__input -select" id="cardMonth" name="cardMonth" v-model="cardMonth"
                            ...
                            <select class="card-input__input -select" id="cardYear" name="cardYear" v-model="cardYear"
                                    v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardDate">
                    ...
                    <div class="card-form__col -cvv">
                        <div class="card-input">
                            ...
                            <input type="text" name="CVV" class="card-input__input" id="cardCvv" v-mask="'####'" maxlength="4"
